    ...
    <div>
      ...
      <div style={{ padding: "0 280px" }}>
        <div style={{ marginBottom: 40 }}>
          ...
          <span style={{ fontSize: 20, lineHeight: 1.6 }}>
            보은 삼년산성은 우리나라 대표 석축산성으로 신라 자비마립간 13년 470에 축조되었고
            소지마립간8년486에 대규모로 수리되었다. 이 성은 신라가 서북 지방으로 세력을 확장하는 데
            중요한 전초기지로 사용되었으며, 삼국사기에 축성을 시작한 지 3년 만에 완성되어
            삼년산성이라 부르게 되었다고 기록되어 있다. 이곳은 삼국통일 전쟁 때 태종무열왕654~661이
            당나라 사신 왕문도를 접견하는 장소로 이용되었다. 이후 고려 태조 왕건918~943이 이성을
            점령하려고 하였으나 크게 패하였다.산성 둘레는 1,680m, 최고 높이 22m, 폭
          </span>
        </div>
